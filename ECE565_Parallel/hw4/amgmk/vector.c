...
int hypre_SeqVectorSetDataOwner(hypre_Vector *vector,
                                int owns_data)
{
   int ierr = 0;
...
int hypre_SeqVectorPrint(hypre_Vector *vector,
                         char *file_name)
{
   FILE *fp;
...
int hypre_SeqVectorSetConstantValues(hypre_Vector *v,
                                     double value)
{
...
int hypre_SeqVectorCopy(hypre_Vector *x,
                        hypre_Vector *y)
{
...
int hypre_SeqVectorScale(double alpha,
                         hypre_Vector *y)
{
   double *y_data = hypre_VectorData(y);
...
int hypre_SeqVectorAxpy(double alpha,
                        hypre_Vector *x,
                        hypre_Vector *y)
{
   double *x_data = hypre_VectorData(x);
